    ...
    return (
      <div className="container mx-auto lg:my-2">
        ...
        <div className="flex flex-wrap justify-center mx-6">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="p-4 md:w-1/3 flex justify-center animate-pulse">
  ...
  return (
    <div className="container mx-auto lg:my-2">
      ...
      {blogs.length === 0 ? (
        ...
        <div className="flex flex-wrap justify-center mx-6">
          {blogs.map((blog) => (
            <div key={blog.id || blog.slug} className="p-4 md:w-1/3 flex justify-center">
              <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg bg-card hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="px-6 md:my-11 lg:my-0 md:h-72 lg:h-64 lg:py-4 xl:h-52 mt-5">
                  ...
                  <p className="text-muted text-base line-clamp-3">
                    {blog.description}
                  </p>
